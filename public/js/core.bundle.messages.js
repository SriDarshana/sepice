...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        ...
        title: "Chilli Powder",
        description: "100% pure chilli powder",
      ...
      
      {
        ...
        href: "/blocks/hero/",
        title: "Hero",
        description: "Shows a hero banner on the top of the page. The section supports a background image with an overlay to improve contrast. The hero includes a headline and optional breadcrumb for site navigation.",
      ...
      
      {
        ...
        href: "/about/mission/",
        title: "Mission",
        description: "our mission njkdsbckjnsdlc dbc. c dc dkcd b uebfq befi qurfbo qgrfoiqb fib. rbuf iureb fib qirbf qrofb rf  fbbe febr fbe bfrref beb rfu beurbf uebruifberbfbe rfb erbfb ejkrf kbs kibfib.",
      ...
      {
        id: 21,
        href: "/blocks/separator/",
        title: "Separator",
        description: "Adds a horizontal section separator. The separator spans the entire page from edge to edge on smaller devices. On larger screens, the line is bound by the maximum container width that contains the section.",
      ...
      {
        id: 24,
        href: "/blocks/video-message/",
        title: "Video message",
        description: "Features a video with optional messages.",
      ...
      
      {
        ...
        href: "/about/vision/",
        title: "Vision",
        description: "our vision sndkcnksndc dsnock l k  jhef jbejfbqb lfqafhaihfq brfiub b bj ebf fbb bf ibfk sfbnik iwehbfi wief.",
